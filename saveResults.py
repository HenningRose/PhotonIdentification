...
def ToNumpy(y_pred_train, weight_train, root_train, y_pred_test, weight_test, root_test, save_directory):
    ...
    npz_train = root_train[['class', 'y_pt', 'y_eta', 'y_IsTight', 'y_ptcone40','y_Reta', 'y_Rphi', 'y_weta1', 'y_weta2', 'y_deltae', 'y_fracs1', 'y_Eratio', 'y_wtots1', 'y_Rhad', 'y_Rhad1', 'y_f1', 'y_e277','y_ptcone20','y_topoetcone40']]
    npz_test = root_test[['class', 'y_pt', 'y_eta', 'y_IsTight', 'y_ptcone40','y_Reta', 'y_Rphi', 'y_weta1', 'y_weta2', 'y_deltae', 'y_fracs1', 'y_Eratio', 'y_wtots1', 'y_Rhad', 'y_Rhad1', 'y_f1', 'y_e277','y_ptcone20','y_topoetcone40']]
    ...
    savez_compressed(os.path.join('Check', f"/cephfs/user/s6herose/Bachelorarbeit/Programmieren/codemasterthesis/finalScripts/classifier/plots/{save_directory}/npz_train.npz"), npz_train.to_numpy())
    savez_compressed(os.path.join('Check', f"/cephfs/user/s6herose/Bachelorarbeit/Programmieren/codemasterthesis/finalScripts/classifier/plots/{save_directory}/npz_test.npz"), npz_test.to_numpy())
...
def ToRoot(y_pred_train, weight_train, root_train, y_pred_test, weight_test, root_test, conversion_type, save_directory):
    ...
    try:
        os.remove(f"/cephfs/user/s6herose/Bachelorarbeit/Programmieren/codemasterthesis/finalScripts/classifier/plots/{save_directory}/signal_{conversion_type}_NN_results.root")
    except OSError:
        pass

    try:
        os.remove(f"/cephfs/user/s6herose/Bachelorarbeit/Programmieren/codemasterthesis/finalScripts/classifier/plots/{save_directory}/background_{conversion_type}_NN_results.root")
    except OSError:
        pass
    
    # create root file for signal and background
    sgn_root = up.recreate(f"/cephfs/user/s6herose/Bachelorarbeit/Programmieren/codemasterthesis/finalScripts/classifier/plots/{save_directory}/signal_{conversion_type}_NN_results.root", compression=up.ZLIB(4))
    ...
    bkg_root = up.recreate(f"/cephfs/user/s6herose/Bachelorarbeit/Programmieren/codemasterthesis/finalScripts/classifier/plots/{save_directory}/background_{conversion_type}_NN_results.root", compression=up.ZLIB(4))
