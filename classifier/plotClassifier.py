...
""" 
This script contains all functions that are used to create all plots in the classifier network.
...
def Distributions(conversion, sgn_data, bkg_data, stage, plot_type, save_directory):
    ...
    #fig.tight_layout()
    fig_eta.savefig(f"/cephfs/user/s6herose/Bachelorarbeit/Programmieren/codemasterthesis/finalScripts/classifier/plots/{save_directory}/eta_{stage}.pdf", bbox_inches='tight')
    plt.close(fig_eta)
    fig_pt.savefig(f"/cephfs/user/s6herose/Bachelorarbeit/Programmieren/codemasterthesis/finalScripts/classifier/plots/{save_directory}/pt_{stage}.pdf", bbox_inches='tight')
    plt.close(fig_pt)
...
def Loss(conversion, model_history, save_directory):
    ...
    axs.plot(train_test, color='darkorange', lw=1.5, label='Kontrolle')
    axs.set_ylabel(r"$L_{classifier}$", fontsize=label_size)
    axs.set_xlabel('Epochen', fontsize=label_size)
    axs.grid(True)
    ...
    #fig.tight_layout()
    plt.savefig(f"/cephfs/user/s6herose/Bachelorarbeit/Programmieren/codemasterthesis/finalScripts/classifier/plots/{save_directory}/loss.pdf", bbox_inches='tight')
    plt.close
...
def ROC(conversion, y_train, y_train_pred, w_train, y_test, y_test_pred, w_test, plot_type, save_directory):
    ...
    #fig.tight_layout()
    plt.savefig(f"/cephfs/user/s6herose/Bachelorarbeit/Programmieren/codemasterthesis/finalScripts/classifier/plots/{save_directory}/ROC.pdf", bbox_inches='tight')
    plt.close
...
def classifierPredictions(conversion, y_train, y_train_pred, w_train, y_test, y_test_pred, w_test, plot_type, save_directory):
    ...
    #fig.tight_layout()
    fig_train.savefig(f"/cephfs/user/s6herose/Bachelorarbeit/Programmieren/codemasterthesis/finalScripts/classifier/plots/{save_directory}/score_train.pdf", bbox_inches='tight')
    plt.close(fig_train)
    fig_test.savefig(f"/cephfs/user/s6herose/Bachelorarbeit/Programmieren/codemasterthesis/finalScripts/classifier/plots/{save_directory}/score_test.pdf", bbox_inches='tight')
    plt.close(fig_test)
...
def Efficiency(conversion, y_train, y_train_pred, w_train, tight_train, y_test, y_test_pred, w_test, tight_test, save_directory):
    ...
    fig.tight_layout()
    plt.savefig(f"/cephfs/user/s6herose/Bachelorarbeit/Programmieren/codemasterthesis/finalScripts/classifier/plots/{save_directory}/efficiency.pdf", bbox_inches='tight')
    plt.close()
...
def JSD(conversion, y_train, y_train_pred, w_train, tight_train, iso_train, y_test, y_test_pred, w_test, tight_test, iso_test, plot_type, save_directory):
    ...
    train_frame['mcTotWeight']= w_train
    train_frame['y_IsTight']= tight_train
    train_frame['y_ptcone40']= iso_train
    test_frame['y_true'] = y_test
    test_frame['y_pred'] = y_test_pred
    test_frame['mcTotWeight']= w_test
    test_frame['y_IsTight']= tight_test
    test_frame['y_ptcone40']= iso_test
    ...
    tight_heights_pass = getBinHeight(tight_pass['y_ptcone40'], tight_pass['mcTotWeight'], 60, 0, 150)
    tight_heights_fail = getBinHeight(tight_fail['y_ptcone40'], tight_fail['mcTotWeight'], 60, 0, 150)

    y_train_heights_inclusive = getBinHeight(train_bkg['y_ptcone40'], train_bkg['mcTotWeight'], 60, 0, 150)
    y_test_heights_inclusive = getBinHeight(test_bkg['y_ptcone40'], test_bkg['mcTotWeight'], 60, 0, 150)
    ...
    for cut in array:
        ...
        y_train_heights_pass = getBinHeight(train_pass['y_ptcone40'], train_pass['mcTotWeight'], 60, 0, 150)
        y_train_heights_fail = getBinHeight(train_fail['y_ptcone40'], train_fail['mcTotWeight'], 60, 0, 150)
        y_test_heights_pass = getBinHeight(test_pass['y_ptcone40'], test_pass['mcTotWeight'], 60, 0, 150)
        y_test_heights_fail = getBinHeight(test_fail['y_ptcone40'], test_fail['mcTotWeight'], 60, 0, 150)        
    ...
    ax1_pass.set_xlabel(r'Untergrundunterückung $b_{R}$', fontsize=label_size)
    ax1_pass.set_ylabel(r'$1/JSD$', fontsize=label_size)
    ...
    ax1_fail.set_xlabel(r'Untergrundunterückung $b_{R}$', fontsize=label_size)
    ax1_fail.set_ylabel(r'$1/JSD$', fontsize=label_size)
    ...
    fig_fail.savefig(f"/cephfs/user/s6herose/Bachelorarbeit/Programmieren/codemasterthesis/finalScripts/classifier/plots/{save_directory}/JSD_fail.pdf", bbox_inches='tight')
    plt.close(fig_fail)
    fig_pass.savefig(f"/cephfs/user/s6herose/Bachelorarbeit/Programmieren/codemasterthesis/finalScripts/classifier/plots/{save_directory}/JSD_pass.pdf", bbox_inches='tight')
    plt.close(fig_pass)